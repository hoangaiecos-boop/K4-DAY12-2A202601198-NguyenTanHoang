...
class ChatStore:
    ...
    def ping(self) -> bool:
        ...
        try:
            ...
            # Bắt rộng là cố ý: readiness probe không được ném lỗi ra ngoài,
            # dù Redis chết vì mạng, vì mật khẩu hay vì chưa khởi động xong.
            return False
    ...
    def add_turn(self, client_id: str, role: str, content: str) -> None:
        ...
        # Giữ HISTORY_MAX_MESSAGES message mới nhất: -N tới -1 là N phần tử cuối.
